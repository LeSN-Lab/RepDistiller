...
#새로 만든 cifar100csv
test_loader = CIFAR10Dataset(csv_file='/home/shared/AI2/ERAN/data/cifar10_test.csv')
...
def onnxModelAccuracy():
  #convert onnx model to torch model
  model = convertModel('/home/shared/AI2/RepDistiller/onnx/resnet8teacher/resnet8.onnx')
  model.eval()
