...
from AI2_MODELS.RepDistiller.onnx.resnet import resnet20  # Assume the provided code is in 'model_code.py'
...
checkpoint = torch.load('/home/shared/AI2/RepDistiller/save/student_model/S:resnet20_T:resnet56_cifar100_kd_r:0.1_a:0.9_b:0.0_1/resnet20_best.pth', map_location)
...
def compareOutput():
  ...
  ort_session = onnxruntime.InferenceSession("resnet20.onnx")
